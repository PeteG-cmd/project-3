            ...
            <section className="LatestBooksContainer">
              ...
              <div className="LatestBookCards">
                ...
                <div className="LatestBookCard">
                  <div className="LatestBookCardImageContainer">
                    <figure>
                      {this.state.user.booksRead && <Link to='/mylibrary'><img src={this.state.user.booksRead[0].thumbnail} alt="" className="LatestBookCardContent"></img></Link>}
                    </figure>
                  </div>
                </div>
              </div>
            ...
            <section className="LatestBooksContainer">
              <div className="LatestBookCards">
                ...
                <div className="LatestBookCard">
                  <div className="LatestBookCardImageContainer">
                    <figure>
                      {this.state.user.booksWishList && <Link to='/mylibrary'><img src={this.state.user.booksWishList[0].thumbnail} alt="" className="LatestBookCardContent"></img></Link>}
                    </figure>
                  </div>
                </div>
              </div>
